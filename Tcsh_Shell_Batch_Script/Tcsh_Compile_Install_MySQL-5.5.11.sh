...
set TARGET_C_COMPILER = "Clang13" # Optional: Clang13 / GCC

set STORAGE = /home/goufeng

# ####################################################################################################
# ################################ Start: Compile Install cmake-2.8.5 ################################
if ( ! -d "/usr/local/cmake-2.8.5" ) then
    ...
    make && make install                        && \
    set Deploy_cmake_2_8_5 = 1                  && \
    set Remove_cmake_2_8_5 = 1
    # ==================================================
    if ( $? == 0 && $Deploy_cmake_2_8_5 == 1 ) then
        # ##################################################
        # ############## Deploy cmake-2.8.5 ################
        # --------------------------------------------------
        # ------------------ Binary File -------------------
    ...
    # ==================================================
    if ( $? == 0 && $Remove_cmake_2_8_5 == 1 ) then
...
if ( ! -d "/usr/local/mysql-5.5.11" ) then
    ...
    cd $STORAGE/mysql-5.5.11
    # ############################################################
    # ################ Error Handle mysql-5.5.11 #################
    ...
    make && make install                                          && \
    set Granting_mysql_5_5_11 = 1                                 && \
    set Deploy_mysql_5_5_11 = 1                                   && \
    set Remove_mysql_5_5_11 = 1
    # ############################################################
    ...
    if ( $? == 0 && $Granting_mysql_5_5_11 == 1 ) then
        chown -R mysql:mysql /usr/local/mysql-5.5.11
    endif
    # ============================================================
    if ( $? == 0 && $Deploy_mysql_5_5_11 == 1 ) then
        # ########################################################
        # ################# Deploy mysql-5.5.11 ##################
        # --------------------------------------------------
        # ------------------ Binary File -------------------
    ...
    #endif
    # ============================================================
    if ( $? == 0 && $Remove_mysql_5_5_11 == 1 ) then
